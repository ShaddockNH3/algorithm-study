...
void test() {
    ...
    for (int i = 0; i < n_rows; i++) {
        ...
        if (i == 0) {
            ...
            prefix_sum_of_row_sums[i] = sum_of_each_row[i] + prefix_sum_of_row_sums[i
- 1];
    ...
    for (int j = 0; j < m_cols; j++) {
        ...
        if (j == 0) {
            ...
            prefix_sum_of_col_sums[j] = sum_of_each_col[j] + prefix_sum_of_col_sums[j
- 1];
    ...
    // min_diff_if_vertical_cut = getsmall(prefix_sum_of_col_sums) -> getsmall([20,
 29]) -> 11
