...
1. 直到栈为空，将left数组标识符定位-1

1. 或者当栈顶元素终于小于数组内的元素时，left数组标识符等于栈顶
...
int main() {
    ...
    for (int i = 0; i < n; i++) {
        long long sum = sum_arr[right_arr[i]
            - 1]
            - (left_arr[i] == -1 ? 0 : sum_arr[left_arr[i]]);
...
[link-1]: http://ds.fzu.edu.cn/std/exp/bf5279a1-1205-4fac-86cd-dc2b5a821f48/cd083306-92aa-4473-ba00-e117d49d4b40/78328dd0-d6c3-41e9-a68b-be9834109393/
