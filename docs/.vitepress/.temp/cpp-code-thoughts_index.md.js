...
const __pageData = JSON.parse('{"title":"C++ 代码随想录","description":"","frontmatter":{},"headers":[],"relativePath":"cpp-code-thoughts/index.md","filePath":"cpp-code-thoughts/index.md","lastUpdated":null}');
const _sfc_main = { name: "cpp-code-thoughts/index.md" };
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("cpp-code-thoughts/index.md");
