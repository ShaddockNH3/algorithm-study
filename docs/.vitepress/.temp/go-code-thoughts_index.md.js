...
const __pageData = JSON.parse('{"title":"Go 代码随想录","description":"","frontmatter":{},"headers":[],"relativePath":"go-code-thoughts/index.md","filePath":"go-code-thoughts/index.md","lastUpdated":null}');
const _sfc_main = { name: "go-code-thoughts/index.md" };
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("go-code-thoughts/index.md");
